...
icon=r'C:\Users\Admin\OneDrive\Desktop\copper modeling\copper-pipes.jpg'
...
if selected == 'Home':
    ...
    with col2:
        st.image(r'C:\Users\Admin\OneDrive\Desktop\copper modeling\copper-pipes.jpg')
...
if selected == "About":
    ...
    st.link_button('Linkedin','https://linkedin.com/in/saravanan-r-864489208/') 